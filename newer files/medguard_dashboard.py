    ...
    def run(self):
        ...
        with tab2:
            ...
            **INNOVATION #1: No other system tracks where baby fish go!**
            ...
            We map larval dispersal corridors using oceanographic modeling.
            """)
        ...
        with tab3:
            ...
            **INNOVATION #2: AI-powered enforcement!**
            ...
            We detect suspicious fishing patterns by analyzing AIS transmission gaps and spatial clustering.
            """)
            ...
            if 'illegal_fishing_suspects' in self.datasets:
                ...
                st.success("✅ **All Clear**: No suspicious patterns detected")
        ...
        with tab6:
            ...
            if self.datasets:
                ...
                with col1:
                    if st.button("📥 Download Risk Data"):
                        st.info("Export functionality available in full version")
                
                with col2:
                    if st.button("📥 Download MPA Recommendations"):
                        st.info("Export functionality available in full version")
